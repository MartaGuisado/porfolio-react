...
function Home() {
  // 🌀 Efecto para voltear las tarjetas al hacer clic
  useEffect(() => {
...
Combino creatividad, técnica y sensibilidad para dar vida a proyectos que conectan marcas y personas a través de la emoción, la claridad y el propósito.
      ...
      <div className="cards-section">
        ...
        {/* Tarjeta 1: Habilidades destacadas */}
        ...
        <div className="info-card flip-card">
          <div className="flip-inner">
            <div className="card-front">
              ...
              <p>
                Creo en la unión entre estrategia y diseño.
                Cada proyecto es una oportunidad para conectar con las personas.
              </p>
            </div>
            <div className="card-back">
